...
public class WebTableTasks {
    ...
    public void p3_verify_susans_order_date(){
        WebElement susansDate = driver.findElement(By.xpath("//td[.='Susan McLaren']/following-sibling::[3]"));
        //System.out.println("Susans' date = "+susansDate.getText());
        String expectedDate = "31/05/2010";
        ...
        //TODO: something (fix locator for example)
    }
